...
HWMON_CONFIG = {
	...
	'4-0010' :  {
		'names' : {
			...
			'curr1_input' : { 'object_path' : 'HSCA/Iout','poll_interval' : 5000,'scale' : 3,'units' : 'A' },
			'in2_input' : { 'object_path' : 'HSCA/Vout','poll_interval' : 5000,'scale' : 3,'units' : 'V' },
		}
	},
	'5-0010' :  {
		'names' : {
			'curr1_input' : { 'object_path' : 'HSCB/Iout','poll_interval' : 5000,'scale' : 3,'units' : 'A' },
			'in2_input' : { 'object_path' : 'HSCB/Vout','poll_interval' : 5000,'scale' : 3,'units' : 'V' },
		}
	},
	'6-0010' :  {
		'names' : {
			'curr1_input' : { 'object_path' : 'HSCC/Iout','poll_interval' : 5000,'scale' : 3,'units' : 'A' },
