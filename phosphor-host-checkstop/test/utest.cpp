 ...
 */
TEST_F(CheckstopTest, noEventIn3Seconds)
{
    using namespace std::chrono;

    Handler xstop(DEVICE, line, events, callbackHandler);
...
TEST_F(CheckstopTest, pumpDataAndExpectCallBack)
{
    using namespace std::chrono;
